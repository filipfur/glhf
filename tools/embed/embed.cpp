...
void embed_to_cpp(const char *in_file, const char *out_file, const ReplaceList &replaceList) {
    ...
    fprintf(file, "extern const unsigned char _embed_%s[];\n", symbol_name.c_str());
    fprintf(file, "extern const size_t _embed_%s_length;\n", symbol_name.c_str());
    fprintf(file, "const unsigned char _embed_%s[] = {", symbol_name.c_str());
    ...
    fprintf(file, " 0x00};\n");
    fprintf(file, "const size_t _embed_%s_length = %zu;\n", symbol_name.c_str(), content.length());
